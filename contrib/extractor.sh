...
DATA_DIR=${SERVER_DIR}/env/data
MAPEXTRACTOR=${SERVER_DIR}/env/bin/mapextractor
VMAP4EXTRACTOR=${SERVER_DIR}/env/bin/vmap4extractor
VMAP4ASSEMBLER=${SERVER_DIR}/env/bin/vmap4assembler
MMAPS_GENERATOR=${SERVER_DIR}/env/bin/mmaps_generator
